...
mport org.jdesktop.swingx.autocomplete.AutoCompleteDecorator;
 ...
 * @author Msys
 */
public class pbuy extends javax.swing.JPanel {
   ...
   private boolean b=false;
    ...
    public pbuy() {
        initComponents();
        String Q[]={"mahde","souqi","world","hello","memo","mohamad","mahmmod"};
        box=new JComboBox(Q);
    ...
    private void initComponents() {
        ...
        tableorder.setGridColor(new java.awt.Color(204, 51, 0));
        ...
        datereach.setBackground(new java.awt.Color(204, 51, 0));
        datereach.setDateFormatString("dd, MM, yyyy");

        dateorder.setBackground(new java.awt.Color(204, 51, 0));
        dateorder.setDateFormatString("dd, MM, yyyy");

        insert.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        insert.setForeground(new java.awt.Color(204, 51, 0));
        ...
        tableitem.setGridColor(new java.awt.Color(204, 51, 0));
        tableitem.setSelectionBackground(new java.awt.Color(255, 153, 0));
